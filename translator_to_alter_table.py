...
def main(path):
    ...
    for schema in schemas:
        ...
        #     continue
        if schema_name not in ['escdb-600']:
            continue
        ...
        for table in tables:
            table_name = table[0]
            if table_name not in tablePending:
                continue
            ...
            if not table_comment:
                ...
                translated_comment = table_comment
    ...
    csv_file = path + 'target/alter_statements-table-600.csv'
    ...
    excel_file = path + 'target/alter_statements-table-600.xlsx'
    # 创建DataFrame
